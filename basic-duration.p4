    ...
    apply {
        //If the ipv4 header is valid, apply the table.
            ...
            if (exist_value == 0){
                ...
                r_duration.write(meta.flowID, 0);
            ...
            //Otherwise if the value is not default, it has been set. This is a registered flow.
                ...
                bit<48> initialTime;
                r_startTime.read(initialTime, meta.flowID);
                //The duration of the flow is equal to current time recorded in the switch - the time
                //the packet entered the switch
                r_duration.write(meta.flowID, standard_metadata.ingress_global_timestamp - initialTime);
            }   
    }
}
